  ...
  <div class="w-full max-w-2xl mx-auto pt-48 2xl:pt-32">
    ...
    <div class="bg-white sn:px-20 sm:p-10 p-6 rounded-xl pb-14 border">
      <div class="my-10 text-center">
        ...
        <p class="mt-1 text-slate-600">Get the ability to comment, add reactions and more!</p>
      </div>
      ...
      <form @submit.prevent="handleSignIn()">
        ...
        <div class="my-10">
          <Button size="sm" class="w-full rounded-lg" type="submit" :loading="isLoading"> Sign in </Button>
        </div>

        <p class="text-slate-600">New user? <AppLink to="/register">Sign up</AppLink></p>
      </form>
    </div>
  </div>
</template>
