...
<template>
  <div>
    <Cursor />
    <div class="relative isolate mx-auto sm:pt-20 max-w-6xl px-4 xs:px-0">
      <GradientTop />
      <section class="text-left">
        <div class="mt-32">
          ...
          <p class="leading-8 sm:leading-10 sm:text-xl text-justify sm:text-left mt-10 text-slate-600">
            ...
            years old. My main interest is programming; I'am passionate about gaining knowledge and solving new problems while working on
            new projects. I mainly use rust, go, typescript and vue js. When I'm not online I enjoy reading books, working out at the gym,
        ...
        <div class="mt-14 flex w-max">
          ...
          <Button class="flex items-center mx-auto" href="/posts" color="bg-transparent">
            Read my blog
            <ArrowRightIcon class="w-4 h-4 ml-2"></ArrowRightIcon>
          </Button>
        </div>
      ...
      <section class="mt-44">
        ...
        <p class="sm:text-xl text-slate-600 mt-7">I love to share my knowledge through writing. Check some of my new posts:</p>
        <div v-if="data" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-16 gap-10">
